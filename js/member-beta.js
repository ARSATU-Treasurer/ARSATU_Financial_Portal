document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ==========================================
    // 🌟 ดึงข้อมูลแบบร่าง / เคลียร์ล่วงหน้า
    // ==========================================
    ...
    // ==========================================
    // 🌟 ฟังก์ชันลบแบบร่างของ Member (เพิ่มใหม่ใน Beta)
    // ==========================================
    ...
    window.loadData = async function() {
        ...
        try {
            ...
            tbody.innerHTML = data.map(req => {
                ...
                // 🌟 อัปเดต Beta: เพิ่มปุ่มลบ ให้โชว์คู่กับปุ่มแก้ไข เมื่อสถานะเป็น Draft
                if (req.status === 'draft') { 
