document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ==========================================
    // 🌟 โหลดรายชื่อ Co-Worker (ใส่ใน Pop-up สร้างบิล)
    // ==========================================
    ...
    function setupClearanceUI() {
        ...
        // 🌟 แก้ไขปุ่มแสดงคำแนะนำ Google Sheet
    ...
    async function processRequest(isDraft) {
        ...
        try {
            ...
            // รวบรวม ID ของ Co-Worker ที่ถูกเลือก
            const coWorkerIds = []; 
